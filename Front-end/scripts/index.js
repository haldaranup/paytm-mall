///*********************************************************************************** */
let icon_url="https://warm-beach-74422.herokuapp.com/couponHome";
const fetchData = async (icon_url) => {
  try {
    let res = await fetch(icon_url);
...
const appendData = async (parent, start, end) => {
  try {
    // let url = "notes";
    let data = await fetchData(icon_url);
...
const appendDataSpecial = async (parent, start, end) => {
  try {
    let url = "https://warm-beach-74422.herokuapp.com/couponHome";
